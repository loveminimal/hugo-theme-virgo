...
> 🙃🙃🙃 该版本已稳定使用了很长一段时间，也到时候暂时说再见了。起初，是想做一个极度精简的版本，但是在后续编写的过程中，强迫症甚是‘嚣张’，加的东西越来越多，魔改也越来越多，当然，作为使用者来说，你完全不心担心这些。
>
> 现在，我想要去做一个极简功能的主题了，自用，它会功能少到近似简陋，也不会针对 markdown 本身做什么扩展。会移除掉许多功能，在保证便利性的基础上，以‘少’为先。
>
> 对于喜欢当前主题的朋友，也不用担心，因为它真的已经很稳定了，当然，如果真的出现了什么问题，可以联系我一起讨论。
>
> 使用愉快，朋友们。
